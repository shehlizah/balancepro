...
cp "$RENDER_DIR" "$WL_BACKUP_FOLDER"
cp "$CSS_DIR" "$WL_BACKUP_FOLDER"
cp "$PG_STG1" "$WL_BACKUP_FOLDER"
#cp "$PG_CHECK_TAGS" "$BACKUP_FOLDER"
cp "$PG_CHECK" "$WL_BACKUP_FOLDER"
cp "$PG_LS" "$WL_BACKUP_FOLDER"
cp "$PG_NEW_CHECK" "$WL_BACKUP_FOLDER"
cp "$PG_SORT_CHECK" "$WL_BACKUP_FOLDER"
cp "$PG_TAGS_NCHECK" "$WL_BACKUP_FOLDER"
cp "$PG_BTN_LS" "$WL_BACKUP_FOLDER"
#cp "$PG_BTN_NEW_LS" "$BACKUP_FOLDER"
cp "$PG_BTN_TAGS" "$WL_BACKUP_FOLDER"
cp "$PGN_BTN_RS" "$WL_BACKUP_FOLDER"
cp "$RS_ALL" "$WL_BACKUP_FOLDER"
cp "$RS_LS" "$WL_BACKUP_FOLDER"
cp "$RS_PG_ALL_NEW" "$WL_BACKUP_FOLDER"
cp "$RS_PG_BACK_CONTENT" "$WL_BACKUP_FOLDER"
#cp "$RS_SEARCH_PG_CONNTENT" "$WL_BACKUP_FOLDER"
cp "$RS_SEARCH_NEW" "$WL_BACKUP_FOLDER"
cp "$RS_SORT_SEARCH" "$WL_BACKUP_FOLDER"
cp "$RS_TAG_SEARCH" "$WL_BACKUP_FOLDER"
cp "$SEARCH_QUERY" "$WL_BACKUP_FOLDER"
cp "$WL_SQP" "$WL_BACKUP_FOLDER"
cp "$RS_PG_CONTENT" "$WL_BACKUP_FOLDER"
cp "$RS_SEARCH" "$WL_BACKUP_FOLDER"
...
cp "$MAIN_CSS" "$MAIN_BACKUP_FOLDER"
cp "$RENDER_DIR_MAIN" "$MAIN_BACKUP_FOLDER"
# cp "$TEMP_HOME" "$MAIN_BACKUP_FOLDER"
cp "$MAIN_PG_STG1" "$MAIN_BACKUP_FOLDER"
#cp "$MAIN_PG_CHECK_TAGS" "$MAIN_BACKUP_FOLDER"
cp "$MAIN_PG_CHECK" "$MAIN_BACKUP_FOLDER"
...
cp "$MAIN_PG_BTN_NEW_LS" "$MAIN_BACKUP_FOLDER"
cp "$MAIN_PG_BTN_TAGS" "$MAIN_BACKUP_FOLDER"
cp "$MAIN_PGN_BTN_RS" "$MAIN_BACKUP_FOLDER"
cp "$MAIN_RS_ALL" "$MAIN_BACKUP_FOLDER"
cp "$MAIN_RS_LS" "$MAIN_BACKUP_FOLDER"
cp "$MAIN_RS_PG_ALL_NEW" "$MAIN_BACKUP_FOLDER"
cp "$MAIN_RS_PG_BACK_CONTENT" "$MAIN_BACKUP_FOLDER"
cp "$MAIN_RS_SEARCH_PG_CONTENT" "$MAIN_BACKUP_FOLDER"
cp "$MAIN_RS_SEARCH_NEW" "$MAIN_BACKUP_FOLDER"
cp "$MAIN_RS_SORT_SEARCH" "$MAIN_BACKUP_FOLDER"
cp "$MAIN_RS_TAG_SEARCH" "$MAIN_BACKUP_FOLDER"
cp "$MAIN_RS_PG_CONTENT" "$MAIN_BACKUP_FOLDER"
cp "$MAIN_RS_SEARCH" "$MAIN_BACKUP_FOLDER"
cp "$MAIN_SEARCH_QUERY" "$MAIN_BACKUP_FOLDER"
cp "$MAIN_SQ_PG" "$MAIN_BACKUP_FOLDER"
cp "$MAIN_RS_TAGS" "$MAIN_BACKUP_FOLDER"
