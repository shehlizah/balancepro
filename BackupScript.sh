...
mkdir -p "$RELATED_ARTICLES/balancepro/domains/whitelabel.balancepro.org/public_html/includes"
...
cp "$RLT_ARTICLES" "$RELATED_ARTICLES/balancepro/domains/whitelabel.balancepro.org/public_html/includes/"
