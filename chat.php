					...
					<tr class="user-nickname-wrap">
						<td style="padding:10px 10px 10px 10px;border-left: 1px solid black;border-right: 1px solid black;" colspan="2"><label for="nickname" style="font-size: 15px;font-weight:600;color:#1d2327;"><?php _e( 'Enable Contact Page' ); ?></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                        ...
                                                        ?>
                                                                  ...
                                                                  <input type="checkbox" class="checkbox-null toggleCheck" name="contact_page" checked="checked" style="padding-top:10px !important" onclick="disableContactForms(this)">
                                                        <?php
                                                                } else {
                                                        ?>
                                                                  <input type="checkbox" class="checkbox-null toggleCheck" name="contact_page" style="padding-top:10px !important" onclick="disableContactForms(this)">
                                                        <?php } ?>
							<br>
					...
					<tr class="user-nickname-wrap">
						<td style="padding:10px 10px 10px 10px;border-left: 1px solid black;border-right: 1px solid black;" colspan="2"><label for="nickname" style="font-weight:600;color:#1d2327;font-size: 15px;"><?php _e( 'Enable Contact Address' ); ?></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							...
							?>
								  ...
								  <input type="checkbox" class="checkbox-null toggleCheck" name="contact_address" id="contact_addresses" checked="checked" style="padding-top:10px !important">
							<?php
								} else if(isset($chat_value_data['contact_page'])=='' && isset($chat_value_data['contact_address'])=='1') {
							?>

								  <input type="checkbox" class="checkbox-null toggleCheck" name="contact_address" id="contact_addresses" disabled="disabled" style="padding-top:10px !important">
							<?php
							...
							?>
								  <input type="checkbox" class="checkbox-null toggleCheck" name="contact_address" id="contact_addresses" style="padding-top:10px !important">
							<?php } ?>
					...
					<tr class="user-nickname-wrap">
						<td style="padding:10px 10px 10px 10px;border-left: 1px solid black;border-right: 1px solid black;" colspan="2"><label for="nickname" style="font-weight:600;color:#1d2327;font-size: 15px;"><?php _e( 'Enable Contact Form' ); ?></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							...
							?>
								  ...
								  <input type="checkbox" class="checkbox-null toggleCheck" name="contact_form" id="contact_forms" checked="checked" style="padding-top:10px !important">
							<?php
								} else if(isset($chat_value_data['contact_page'])=='' && isset($chat_value_data['contact_form'])=='1') {
							?>

								  <input type="checkbox" class="checkbox-null toggleCheck" name="contact_form" id="contact_forms" disabled="disabled" style="padding-top:10px !important">
							<?php
							...
							?>
								  <input type="checkbox" class="checkbox-null toggleCheck" name="contact_form" id="contact_forms" style="padding-top:10px !important">
							<?php } ?>
					...
					<tr class="user-nickname-wrap">
						<td style="padding:10px 10px 10px 10px;border-left: 1px solid black;border-right: 1px solid black;border-bottom: 1px solid black;" colspan="2"><label for="nickname" style="font-weight:600;color:#1d2327;font-size: 15px;"><?php _e( 'Enable Contact Number' ); ?></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							...
							?>
								  ...
								  <input type="checkbox" class="checkbox-null toggleCheck" name="contact_number" checked="checked" style="padding-top:10px !important">
							<?php
								} else {
							?>
								  <input type="checkbox" class="checkbox-null toggleCheck" name="contact_number" style="padding-top:10px !important">
							<?php } ?>
						</td>
					</tr>
					<tr>
					...
					<tr class="user-nickname-wrap" style="border-left: 1px solid black;border-right: 1px solid black;">
						<td style="padding:10px 10px 10px 10px;" colspan="2"><label for="nickname" style="font-weight:600;color:#1d2327;font-size: 15px;"><?php _e( 'Enable Chat' ); ?></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							...
							?>
								  ...
								  <input type="checkbox" class="checkbox-null toggleCheck" name="disable_chat" checked="checked" style="padding-top:10px !important">
							<!--<input type="radio" id="Yes" name="disable_chat" checked value="y">
							<label for="Yes">Yes</label>-->
							<?php
								} else {
							?>
								  <input type="checkbox" class="checkbox-null toggleCheck" name="disable_chat" style="padding-top:10px !important">
				        	...
				        	<td>
							  <?php if(isset($chat_value_data['mon_status']) && $chat_value_data['mon_status']=='on'){
								...
								?>
								  ...
								  <input type="checkbox" class="checkbox-null toggleCheck" name="mon_status" checked="checked" style="padding-top:10px !important">
								<?php } else { ?>
									<input type="checkbox" class="checkbox-null toggleCheck" name="mon_status" style="padding-top:10px !important">
								<?php } ?>
						</td><td>
				  	...
				  	<tr style="border-left: 1px solid black;border-right: 1px solid black;">
					  	 ...
					  	 <td>
							  <?php if(isset($chat_value_data['tue_status']) && $chat_value_data['tue_status']=='on'){ ?>
								  <input type="checkbox" class="checkbox-null toggleCheck" name="tue_status" checked="checked" style="padding-top:10px !important">
								<?php } else { ?>
									<input type="checkbox" class="checkbox-null toggleCheck" name="tue_status" style="padding-top:10px !important">
								<?php } ?>
			        ...
			        <tr style="border-left: 1px solid black;border-right: 1px solid black;">
			         	...
			         	<td>
							  <?php if(isset($chat_value_data['wed_status']) && $chat_value_data['wed_status']=='on'){ ?>
								  <input type="checkbox" class="checkbox-null toggleCheck" name="wed_status" checked="checked" style="padding-top:10px !important">
								<?php } else { ?>
									<input type="checkbox" class="checkbox-null toggleCheck" name="wed_status" style="padding-top:10px !important">
								<?php } ?>
			        ...
			        <tr style="border-left: 1px solid black;border-right: 1px solid black;">
			         	...
			         	<td>
							  <?php if(isset($chat_value_data['thu_status']) && $chat_value_data['thu_status']=='on'){ ?>
								  <input type="checkbox" class="checkbox-null toggleCheck" name="thu_status" checked="checked" style="padding-top:10px !important">
								<?php } else { ?>
									<input type="checkbox" class="checkbox-null toggleCheck" name="thu_status" style="padding-top:10px !important">
								<?php } ?>
			        ...
			        <tr style="border-left: 1px solid black;border-right: 1px solid black;">
			         	...
			         	<td>
							  <?php if(isset($chat_value_data['fri_status']) && $chat_value_data['fri_status']=='on'){ ?>
								  <input type="checkbox" class="checkbox-null toggleCheck" name="fri_status" checked="checked" style="padding-top:10px !important">
								<?php } else { ?>
									<input type="checkbox" class="checkbox-null toggleCheck" name="fri_status" style="padding-top:10px !important">
								<?php } ?>
			        ...
			        <tr style="border-left: 1px solid black;border-right: 1px solid black;">
			        	 ...
			        	 <td> 
							  <?php if(isset($chat_value_data['sat_status']) && $chat_value_data['sat_status']=='on'){ ?>
								  <input type="checkbox" class="checkbox-null toggleCheck" name="sat_status" checked="checked" style="padding-top:10px !important">
								<?php } else { ?>
									<input type="checkbox" class="checkbox-null toggleCheck" name="sat_status" style="padding-top:10px !important">
								<?php } ?>
					 ...
					 <tr style="border-left: 1px solid black;border-right: 1px solid black;border-bottom: 1px solid black;">
					 	...
					 	<td>
							  <?php if(isset($chat_value_data['sun_status']) && $chat_value_data['sun_status']=='on'){ ?>
								  <input type="checkbox" class="checkbox-null toggleCheck" name="sun_status" checked="checked" style="padding-top:10px !important">
								<?php } else { ?>
									<input type="checkbox" class="checkbox-null toggleCheck" name="sun_status" style="padding-top:10px !important">
								<?php } ?>
...
foreach ($holidays as $holiday => $date) {
  ...
  <td>
	...
	<td colspan="3">
		<input type="checkbox" class="checkbox-null toggleCheck tc" style="display:none;" name="federal_holiday[]" <?php
