...
cp "$WL_CLONE_FOLDER/main.min.css" "$HOME_WL/assets/css/main.min.css" 
cp "$WL_CLONE_FOLDER/render-search-main-design.php" "$HOME_WL/templates/render-search-main-design.php"
