...
//echo $query;
    ...
    if($dvaluen == 'article'){
    $seo_dvalue = 'http://www.devxekera.com/resources/articles/';
    }else if($dvaluen == 'calculator'){
     $seo_dvalue = 'http://www.devxekera.com/resources/calculators/';
    }else if($dvaluen == 'video'){
     $seo_dvalue = 'http://www.devxekera.com/resources/videos/';
    }else if($dvaluen == 'newsletter'){
     $seo_dvalue = 'http://www.devxekera.com/resources/newsletters/';
    }else if($dvaluen == 'podcast'){
     $seo_dvalue = 'http://www.devxekera.com/resources/podcasts/';
    }else if($dvaluen == 'toolkit'){
     $seo_dvalue = 'http://www.devxekera.com/resources/toolkits/';
    }else if($dvaluen == 'booklet'){
     $seo_dvalue = 'http://www.devxekera.com/resources/booklets/';
    }else{}
        $output = '';
        //$output .= '<div class="resource-column same-height-holder content-inner-page">';
        $output .= '<!-- resource resource in resources starts -->
