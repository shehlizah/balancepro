...
cp "$WL_BACKUP_FOLDER/pagination_new_check.php" "$PG_NEW_CHECK"
cp "$WL_BACKUP_FOLDER/pagination_sort_check.php" "$PG_SORT_CHECK"
cp "$WL_BACKUP_FOLDER/pagination_tags_n_check.php" "$PG_TAGS_NCHECK"
cp "$WL_BACKUP_FOLDER/pg_btn_lifestage.php" "$PG_BTN_LS"
#cp"$WL_BACKUP_FOLDER/.php"  "$PG_BTN_NEW_LS" "$BACKUP_FOLDER"
cp "$WL_BACKUP_FOLDER/pg_btn_tags.php" "$PG_BTN_TAGS"
cp "$WL_BACKUP_FOLDER/pgn_btn_resource.php" "$PGN_BTN_RS"
cp "$WL_BACKUP_FOLDER/resource_all_page.php" "$RS_ALL"
cp "$WL_BACKUP_FOLDER/resource_life_stages.php" "$RS_LS"
cp "$WL_BACKUP_FOLDER/resource_pagination_all_new.php" "$RS_PG_ALL_NEW"
cp "$WL_BACKUP_FOLDER/resource_pagination_back_content.php" "$RS_PG_BACK_CONTENT"
#cp"$WL_BACKUP_FOLDER/.php"  "$RS_SEARCH_PG_CONNTENT"
cp "$WL_BACKUP_FOLDER/resource_search_new.php" "$RS_SEARCH_NEW"
cp "$WL_BACKUP_FOLDER/resource_sort_search.php" "$RS_SORT_SEARCH"
cp "$WL_BACKUP_FOLDER/resource_tag_search.php" "$RS_TAG_SEARCH"
cp "$WL_BACKUP_FOLDER/search_query.php" "$SEARCH_QUERY"
...
cp "$MAIN_BACKUP_FOLDER/pagination_check.php" "$MAIN_PG_CHECK"
cp "$MAIN_BACKUP_FOLDER/pagination_life_stage_check.php" "$MAIN_PG_LS"
cp "$MAIN_BACKUP_FOLDER/pagination_new_check.php" "$MAIN_PG_NEW_CHECK"
cp "$MAIN_BACKUP_FOLDER/pagination_sort_check.php" "$MAIN_PG_SORT"
cp "$MAIN_BACKUP_FOLDER/pagination_tags_check.php" "$MAIN_PG_TAGS_CHECK"
cp "$MAIN_BACKUP_FOLDER/pagination_tags_n_check.php" "$MAIN_PG_TAGS_NCHECK"
cp "$MAIN_BACKUP_FOLDER/pg_btn_lifestage.php" "$MAIN_PG_BTN_LS"
cp "$MAIN_BACKUP_FOLDER/pg_btn_new_lifestage.php" "$MAIN_PG_BTN_NEW_LS"
cp "$MAIN_BACKUP_FOLDER/pg_btn_tags.php" "$MAIN_PG_BTN_TAGS"
cp "$MAIN_BACKUP_FOLDER/pgn_btn_resource.php" "$MAIN_PGN_BTN_RS"
cp "$MAIN_BACKUP_FOLDER/resource_all_page.php" "$MAIN_RS_ALL"
cp "$MAIN_BACKUP_FOLDER/resource_life_stages.php" "$MAIN_RS_LS"
cp "$MAIN_BACKUP_FOLDER/resource_pagination_all_new.php" "$MAIN_RS_PG_ALL_NEW"
cp "$MAIN_BACKUP_FOLDER/resource_pagination_back_content.php" "$MAIN_RS_PG_BACK_CONTENT"
cp "$MAIN_BACKUP_FOLDER/resource_search_pagination_content.php" "$MAIN_RS_SEARCH_PG_CONTENT"
cp "$MAIN_BACKUP_FOLDER/resource_search_new.php" "$MAIN_RS_SEARCH_NEW"
cp "$MAIN_BACKUP_FOLDER/resource_sort_search.php" "$MAIN_RS_SORT_SEARCH"
cp "$MAIN_BACKUP_FOLDER/resource_tag_search.php" "$MAIN_RS_TAG_SEARCH"
cp "$MAIN_BACKUP_FOLDER/resource_pagination_content.php" "$MAIN_RS_PG_CONTENT"
cp "$MAIN_BACKUP_FOLDER/resource_search.php" "$MAIN_RS_SEARCH"
cp "$MAIN_BACKUP_FOLDER/search_query.php" "$MAIN_SEARCH_QUERY"
cp "$MAIN_BACKUP_FOLDER/search_query_pagination.php" "$MAIN_SQ_PG"
cp "$MAIN_BACKUP_FOLDER/resource_tags.php" "$MAIN_RS_TAGS"
