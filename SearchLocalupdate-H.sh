...
cp "$SEARCH_MAIN_CLONE_FOLDER/edit-module-white-label-website-admins.php" "$HOME_MAIN/public_html/wp-content/themes/balance-theme/inc/edit/modules/edit-module-white-label-website-admins.php" || echo "Failed to copy search_query_pagination.php"
