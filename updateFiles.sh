...
#cp "$MAIN_CLONE_FOLDER/pagination_check_tags.php" "$MAIN_PG_CHECK_TAGS" 
...
# cp "$WL_CLONE_FOLDER/pagination_check_tags.php" "$PG_CHECK_TAGS" 
...
# cp "$WL_CLONE_FOLDER/pagination_tags_check.php" "$PG_TAGS_CHECK" 
cp "$WL_CLONE_FOLDER/pg_btn_lifestage.php" "$PG_BTN_LS" 
# cp "$WL_CLONE_FOLDER/pg_btn_new_lifestage.php" "$PG_BTN_NEW_LS" 
cp "$WL_CLONE_FOLDER/pg_btn_tags.php" "$PG_BTN_TAGS" 
cp "$WL_CLONE_FOLDER/pgn_btn_resource.php" "$PGN_BTN_RS" 
cp "$WL_CLONE_FOLDER/resource_all_page.php" "$RS_ALL_PAGE" 
...
# cp "$WL_CLONE_FOLDER/resource_search_pagination_content.php" "$RS_SEARCH_PG_CONNTENT" 
